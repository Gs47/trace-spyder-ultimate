...
menu_body = '''def run_script(script_name):
    ...
    if os.path.exists(path):
        ...
        print(f"\\n\\033[1;31m❌ Error: {script_name} not found!\\033[0m")
        input("Press Enter...")

def main_menu():
    while True:
        clear_screen()
        print("  \\033[1;33m[01]\\033[0m Telegram Tools & Manager")
        print("  \\033[1;33m[02]\\033[0m Ultimate Media Downloader (YT/IG/FB/X/etc)")
        print("  \\033[1;33m[03]\\033[0m Spotify Music Downloader (320kbps)")
        print("  \\033[1;33m[04]\\033[0m TeraBox Video Fast Downloader")
        print("  \\033[1;33m[05]\\033[0m Media & Document Converter Engine")
        print("  \\033[1;33m[06]\\033[0m Seeker OSINT Location Explorer")
        print("  \\033[1;33m[07]\\033[0m Device & Battery Diagnostic Status")
        print("  \\033[1;33m[08]\\033[0m Termux Storage & Cache Purger")
        print("  \\033[1;33m[09]\\033[0m Settings & Engine Updater")
        print("  \\033[1;33m[10]\\033[0m Full System Self-Repair & Auto-Fix Engine")
        print("\\033[1;36m" + "─"*64 + "\\033[0m")
        print("  \\033[1;36m[ 0]\\033[0m Refresh Dashboard")
        print("  \\033[1;31m[ *]\\033[0m Full Exit to Terminal")
        print("\\033[1;36m" + "═"*64 + "\\033[0m")
        
        choice = input("\\033[1;32m➤ Select Option: \\033[0m").strip().lower()
        mapping = {
        ...
        if choice in mapping: run_script(mapping[choice])
            ...
            print("\\n\\033[1;31mExiting Trace Spyder Terminal Hub. Goodbye!\\033[0m\\n")
            sys.exit(0)
...
media_dl_body = '''def main():
    while True:
        clear_screen()
        url = input("\\033[1;32m➤ Enter Video URL ([#] Back / [*] Exit): \\033[0m").strip()
        if url.lower() in ['#', 'b', 'back']: break
        elif url.lower() in ['*', 'x', 'exit', 'q']: os._exit(0)
        elif url:
            out_dir = "/sdcard/Download"
            print(f"\\n\\033[1;33m[*] Downloading into {out_dir}...\\033[0m")
            subprocess.run(["yt-dlp", "-P", out_dir, url])
            input("\\n\\033[1;32m[✓] Download finished. Press Enter...\\033[0m")
...
seeker_body = '''def main():
    while True:
        clear_screen()
        print("  \\033[1;33m[1]\\033[0m Start Seeker OSINT Service")
        print("\\033[1;36m" + "─"*64 + "\\033[0m")
        print("  \\033[1;36m[#]\\033[0m Back to Main Menu")
        print("  \\033[1;31m[*]\\033[0m Full Exit to Terminal")
        print("\\033[1;36m" + "═"*64 + "\\033[0m")
...
settings_body = '''def main():
    while True:
        clear_screen()
        print("  \\033[1;33m[1]\\033[0m Update Core Engines & Python Libs")
        print("\\033[1;36m" + "─"*64 + "\\033[0m")
        print("  \\033[1;36m[#]\\033[0m Back to Main Menu")
        print("  \\033[1;31m[*]\\033[0m Full Exit to Terminal")
        print("\\033[1;36m" + "═"*64 + "\\033[0m")
...
print("✅ 'TRACE SPYDER - TERMINAL HUB' header updated everywhere!")