...
BANNER = r'''
\033[1;36m┌──────────────────────────────────────────────────────────────┐\033[0m
\033[1;33m     _____ ____     _     ____ _____   ____  ______  \033[0m
\033[1;33m    |_   _|  _ \   / \   / ___| ____| / ___||  _ \ \ \033[0m
\033[1;33m      | | | |_) | / _ \ | |   |  _|   \___ \| |_) | | \033[0m
\033[1;33m      | | |  _ < / ___ \| |___| |___   ___) |  __/| | \033[0m
\033[1;33m      |_| |_| \_/_/   \_\____|_____| |____/|_|   |_| \033[0m
\033[1;35m               [ \033[1;96mT R A C E   S P Y D E R\033[1;35m ]\033[0m
\033[1;32m             ⚡ [ T E R M I N A L   H U B ] ⚡\033[0m
\033[1;36m└──────────────────────────────────────────────────────────────┘\033[0m
'''
...
def clear_screen():
    os.system('clear')
    print(BANNER)
    print(f"\\033[1;35m  [▸] ACTIVE MODULE : \\033[1;92m{title}\\033[0m")
...
def main_menu():
    while True:
        ...
        if choice in mapping: run_script(mapping[choice])
            ...
            print("\\n\\033[1;91mExiting Trace Spyder Hub. Goodbye!\\033[0m\\n")
            sys.exit(0)
        else: input("\\n\\033[1;91m❌ Invalid choice! Press Enter...\\033[0m")
...
def main():
    while True:
        ...
        try:
            ...
            print(f"\\033[1;36m[*]\\033[0m Internal Storage (/sdcard):")
        ...
        print(f"\\033[1;36m[*]\\033[0m Battery Diagnostics:")
        print(f"    - Current Level  : \\033[1;92m{batt_lvl}\\033[0m")
        print(f"    - Battery State  : \\033[1;93m{batt_st}\\033[0m")
        print("\\033[1;36m" + "─"*62 + "\\033[0m")
        print(f"\\033[1;36m[*]\\033[0m Architecture     : \\033[1;97m{os.uname().machine}\\033[0m")
        print("\\033[1;36m" + "═"*62 + "\\033[0m")
...
files = {
    ...
    "settings.py": setup_body if 'setup_body' in locals() else wrap_script("SETTINGS & UPDATER", settings_body),
...
print("✅ Trace Spyder Hub optimized for phone screen with vibrant colors applied!")